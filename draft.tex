...
\begin{document}
	...
	surrogate model, followed by an evaluation of the aggregated explanations.
		...
		A summary of some experiments based on the method described above is provided below. The
		model that achieved the best results was trained and evaluated using the methods
		previously described, has an evaluation accuracy of 96.3\% with the default threshold of
